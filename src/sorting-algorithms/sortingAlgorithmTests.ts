...
const stringCompare: ICompare<string> = (arg0, arg1) =>
  numberCompare(parseInt(arg0, 36), parseInt(arg1, 36));

const generateString: IGenerate<string> = (arg0) => arg0.toString(36);

// Tests
console.log("--- Testing Numeric Bubble Sort ---");
const numericBubbleTester = new SortingAlgorithmTester(
  numberSortingAlgorithms.bubbleSort,
  numberCompare,
  generateNumber
);
...
numericBubbleTester.addTest(
  TestType.REVERSE_SORTED,
  generateRandomArrayLength()
);
...
const numericHeapTester = new SortingAlgorithmTester(
  numberSortingAlgorithms.heapSort,
  numberCompare,
  generateNumber
);
...
const numericInsertionTester = new SortingAlgorithmTester(
  numberSortingAlgorithms.insertionSort,
  numberCompare,
  generateNumber
);
...
numericInsertionTester.addTest(
  TestType.REVERSE_SORTED,
  generateRandomArrayLength()
);
...
const numericQuickTester = new SortingAlgorithmTester(
  numberSortingAlgorithms.quickSort,
  numberCompare,
  generateNumber
);
...
const numericSelectionTester = new SortingAlgorithmTester(
  numberSortingAlgorithms.selectionSort,
  numberCompare,
  generateNumber
);
...
const numericShellTester = new SortingAlgorithmTester(
  numberSortingAlgorithms.shellSort,
  numberCompare,
  generateNumber
);
...
const stringBubbleTester = new SortingAlgorithmTester(
  stringSortingAlgorithms.bubbleSort,
  stringCompare,
  generateString
);
