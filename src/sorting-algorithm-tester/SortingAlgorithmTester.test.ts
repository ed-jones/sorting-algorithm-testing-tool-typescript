import SortingAlgorithmTester, { Efficiency, ICompare, IGenerate, ISortingAlgorithm, TestType } from "./SortingAlgorithmTester";
...
describe('Sorting Algorithm Tester Tests', () => {
    const testingTool = new SortingAlgorithmTester(bubbleSort, numberCompare, generateNumber);
    ...
    test('Test bubble sort', () => {
        ...
        expect(console.log).toHaveBeenCalledWith("Preparing tests: Shuffled, Length=1000");
        expect(console.log).toHaveBeenCalledWith("Test 1: Validating length of list.");
    ...
    test('Test efficiency reset', () => {
        ...
        console.log = jest.fn();
        testingTool.runTests();
        expect(console.log).toHaveBeenCalledWith("Preparing tests: Presorted, Length=1000");
        expect(console.log).toHaveBeenCalledWith("Test 1: Validating length of list.");
        expect(console.log).toHaveBeenCalledWith("   Passed. ✔️")
    })
})
